...
char auth[] = "XXX"; // Blynk Auth Token

char ssid[] = "XXX";                           // WiFi Router ssid
char pass[] = "XXX";             // WiFi Router password

const char* server = "api.thingspeak.com";        // Thingspeak Write API
const char* api_key = "XXX";         // API write key 
...
#define LANGUAGE 'PL'               //either 'DE' for German or 'EN' for English

#define TEMP_CORR (0)              //Manual correction of temp sensor (mine reads 1 degree too high)
#define ELEVATION (90)             //Enter your elevation in m ASL to calculate rel pressure (ASL/QNH) at your place

#define sleepTimeMin (3)           //setting of deepsleep time in minutes (default: 10)
